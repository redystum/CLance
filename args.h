...
struct gengetopt_args_info
{
  ...
  char * input_arg;	/**< @brief file to input.  */
  char * input_orig;	/**< @brief file to input original value given at command line.  */
  const char *input_help; /**< @brief file to input help description.  */
  char * output_arg;	/**< @brief file to output.  */
  char * output_orig;	/**< @brief file to output original value given at command line.  */
