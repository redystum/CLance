...
/** @brief Where the command line options are stored */
	struct gengetopt_args_info {
		...
		char *input_arg;
			/**< @brief file to input.  */
		char *input_orig;
			/**< @brief file to input original value given at command line.  */
		const char *input_help;
			  /**< @brief file to input help description.  */
		char *output_arg;
			/**< @brief file to output.  */
		char *output_orig;
			/**< @brief file to output original value given at command line.  */
		const char *output_help;
			   /**< @brief file to output help description.  */
		int accept_flag;
			/**< @brief accept all (default=off).  */
		const char *accept_help;
			   /**< @brief accept all help description.  */
		int verbose_flag;
			/**< @brief Enable verbose mode (default=off).  */
		const char *verbose_help;
			    /**< @brief Enable verbose mode help description.  */
		int format_flag;
			/**< @brief Auto indent output file (default=off).  */
		const char *format_help;
			   /**< @brief Auto indent output file help description.  */
		int build_flag;
			/**< @brief Build the program (default=off).  */
		const char *build_help;
			  /**< @brief Build the program help description.  */
		int run_flag;
		/**< @brief Run the program (default=off).  */
		const char *run_help;
			/**< @brief Run the program help description.  */
		...
		unsigned int input_given;
				/**< @brief Whether input was given.  */
		unsigned int output_given;
				/**< @brief Whether output was given.  */
		unsigned int accept_given;
				/**< @brief Whether accept was given.  */
		unsigned int verbose_given;
				/**< @brief Whether verbose was given.  */
		unsigned int format_given;
				/**< @brief Whether format was given.  */
		unsigned int build_given;
				/**< @brief Whether build was given.  */
		unsigned int run_given;
				/**< @brief Whether run was given.  */
