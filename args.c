  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:a", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* accept all.  */
          ...
          if (update_arg((void *)&(args_info->accept_flag), 0, &(args_info->accept_given),
              &(local_args_info.accept_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "accept", 'a',
              additional_error))
            goto failure;
