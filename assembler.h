...
void program_asm_loop(struct state *s, struct program_node *program, FILE *file, int main);
...
void asm_directive(struct state *s, struct instruction_node *instr, FILE *file);
